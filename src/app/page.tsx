  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 right-1/4 h-[300px] w-[300px] rounded-full bg-cyan-400/15 blur-3xl" />
      </div>
      ...
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-5">
        ...
        <Link
          href="/login"
          className="rounded-full border border-gray-200 bg-white/70 px-5 py-2 text-sm font-medium text-gray-700 shadow-sm backdrop-blur transition-colors hover:bg-white dark:border-gray-700 dark:bg-gray-900/70 dark:text-gray-200 dark:hover:bg-gray-800"
        >
          Sign In
        </Link>
      </header>
      ...
      <main className="mx-auto flex max-w-5xl flex-1 flex-col items-center justify-center px-6 py-16 text-center">
        <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-violet-50/80 px-4 py-1.5 text-sm font-medium text-violet-700 backdrop-blur dark:border-violet-800 dark:bg-violet-950/60 dark:text-violet-300">
        ...
        <Link
          href="/login"
          className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-blue-500 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-violet-500/25 transition-all hover:shadow-xl hover:shadow-violet-500/30"
        >
          Get Started Free
        ...
        <div className="mt-20 grid w-full max-w-3xl gap-5 sm:grid-cols-3">
          {[
            ...
            <div
              key={f.title}
              className="group rounded-2xl border border-gray-100 bg-white/60 p-6 text-left shadow-sm backdrop-blur transition-all hover:shadow-md dark:border-gray-800 dark:bg-gray-900/50"
            >
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-400 dark:text-gray-500">
          <span className="flex items-center gap-1.5"><Zap className="h-3.5 w-3.5" /> Free to start</span>
